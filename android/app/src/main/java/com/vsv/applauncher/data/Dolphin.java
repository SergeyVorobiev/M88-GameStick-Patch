...
public class Dolphin extends AppInfoGetter {

    public Dolphin(Context context) {
        super(context);
        appInfo = new AppInfo();
        appInfo.name = "Dolphin (Wii / GameCube)";
        ...
        appInfo.activityName = "org.dolphinemu.dolphinemu.ui.main.MainActivity";
        ...
        appInfo.configText = "[General]\n" +
                ...
                "ISOPaths = 2\n" +
                "ISOPath1 = content://com.android.externalstorage.documents/tree/primary%3AMusic\n";
