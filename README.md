...
3. Download [GDBTool](https://github.com/SergeyVorobiev/M88-GameStick-Patch/releases/download/v1.2.0/M88GDBTool_1.8.exe).
...
8. [M88GDBTool](https://github.com/SergeyVorobiev/M88-GameStick-Patch/releases/download/v1.2.0/M88GDBTool_1.8.exe).
...
You can download a compiled [Windows version](https://github.com/SergeyVorobiev/M88-GameStick-Patch/releases/download/v1.2.0/M88GDBTool_1.8.exe) or run it from [sources](UIMain.py).
